...
const required = [
  ...
  ['base44/functions/deegoTelegram/entry.ts', "const LEGACY_HOLD_CODE = 'legacy_deego_telegram_held'"],
  ['base44/functions/deegoTelegram/entry.ts', 'Legacy messaging doorway is held.'],
  ['base44/functions/deegoTelegram/entry.ts', 'skipped: true'],
  ['base44/functions/deegoTelegram/entry.ts', 'external_actions: 0'],
...
const forbidden = [
  ...
  ['base44/functions/deegoTelegram/entry.ts', 'fetch('],
  ['base44/functions/deegoTelegram/entry.ts', 'Deno.env'],
  ['base44/functions/deegoTelegram/entry.ts', 'createClientFromRequest'],
  ['base44/functions/deegoTelegram/entry.ts', 'asServiceRole'],
