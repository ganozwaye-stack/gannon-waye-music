...
const required = [
  ...
  ['base44/functions/prepareReleaseEmailDraft/entry.ts', 'Exact owner sign-in is required to prepare a release email draft.'],
  ...
  ['src/components/admin/ReleaseEmailDraftCard.jsx', 'window.prompt'],
  ['src/components/admin/ReleaseEmailDraftCard.jsx', 'confirm_release_fingerprint'],
  ['src/components/admin/ReleaseEmailDraftCard.jsx', 'confirm_draft_fingerprint'],
  ['src/components/admin/ReleaseEmailDraftCard.jsx', 'confirm_send_phrase'],
  ['src/components/admin/ReleaseEmailDraftCard.jsx', 'send_request_id'],
  ...
  ['base44/functions/sendReleaseEmailDraft/entry.ts', 'Exact owner sign-in is required.'],
  ['base44/functions/sendReleaseEmailDraft/entry.ts', 'ReleaseEmailSendReceipt.create'],
  ['base44/functions/sendReleaseEmailDraft/entry.ts', 'confirm_send_phrase'],
  ['base44/functions/sendReleaseEmailDraft/entry.ts', 'expectedSendPhrase'],
  ['base44/functions/publishSingleWorkflow/entry.ts', 'Evidence is frozen after approval begins.'],
  ['base44/functions/publishSingleWorkflow/entry.ts', 'updated_date: release.updated_date'],
