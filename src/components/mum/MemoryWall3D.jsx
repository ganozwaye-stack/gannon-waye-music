...
const PHOTOS = [
  ...
  // Her
  { url: 'https://media.base44.com/images/public/69eb7905ca6eb4180010f794/0300de0f5_3B567D3B-59A6-4B35-8222-64534D6BE5BB.jpg', caption: 'Still smiling, always — her spark never left the room', category: 'Her', featured: true },
  ...
  { url: 'https://media.base44.com/images/public/69eb7905ca6eb4180010f794/c1ecb80cd_CopyofIMG_5546.jpg', caption: 'Flowers, colour, and care — love kept arriving', category: 'Her Flowers' },
  // Carrying Her
  ...
  // Her Flowers (inspired by the colours, softness, and love Sonia carried)
  { url: 'https://media.base44.com/images/public/69eb7905ca6eb4180010f794/795cc3eb2_generated_image.png', caption: 'Flowers — her colours, softness, and bloom.', category: 'Her Flowers', featured: true },
  // Her Words
...
const CATEGORIES = ['All', 'Me & Mum', 'Her', 'Her Humour', 'Family', 'Her Animals', 'Carrying Her', 'Her Flowers', 'Her Words'];
