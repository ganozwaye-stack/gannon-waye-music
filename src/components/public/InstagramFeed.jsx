      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <div>
            ...
            <h2 className="font-display text-3xl text-foreground flex items-center gap-2">
              <Instagram className="w-6 h-6 text-primary/70" /> @ganozwaye
            </h2>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          {PLACEHOLDER_POSTS.map((post, i) => (
            <motion.a
              key={post.id}
              href="https://www.instagram.com/ganozwaye"
              target="_blank"
        ...
        >
          Live Instagram feed coming soon · Follow <a href="https://www.instagram.com/ganozwaye" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">@ganozwaye</a> for updates
        </motion.p>
      </div>
    </section>
  );
