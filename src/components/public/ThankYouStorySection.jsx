...
export default function ThankYouStorySection() {
  ...
  return (
    <section className="py-12 md:py-10 md:py-12 px-4 md:px-6 relative">
        ...
        <div className="hidden md:grid md:grid-cols-[1fr_1.4fr] gap-12 items-start">
          ...
          >
            <div className="border-l-2 border-primary pl-6">
              <p className="font-display text-lg md:text-xl text-muted-foreground italic leading-relaxed">
                {PULL_QUOTE}
              </p>
            </div>
            <div className="flex flex-col gap-3">
              ...
              <Link to="/back-this">
                <button className="w-full border border-foreground/20 text-foreground/80 rounded-full px-6 py-3 font-body text-xs tracking-[0.2em] uppercase hover:bg-primary/10 transition-all">
                  Support the Project
                </button>
              </Link>
          ...
          {!expanded && (
            <div className="relative">
              ...
              <button
                ...
                className="w-full border border-foreground/20 text-foreground/80 rounded-full py-3 font-body text-xs tracking-[0.2em] uppercase hover:bg-primary/10 transition-all"
              >
                Read the full story
              </button>
            </div>
