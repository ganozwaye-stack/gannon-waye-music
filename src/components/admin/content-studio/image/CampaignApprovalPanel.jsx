...
// Lifted from src/pages/admin/CampaignImageApproval.jsx — the 11 campaign images
// mapped to their correct countdown days, with heading selection and approval.
...
export default function CampaignApprovalPanel() {
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <h3 className="font-display text-xl font-bold gradient-gold-text">Campaign Image Approval</h3>
