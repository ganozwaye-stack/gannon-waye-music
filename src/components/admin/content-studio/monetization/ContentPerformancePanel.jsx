...
// Lifted from src/pages/admin/ContentPerformance.jsx — metrics logging with AI
// analysis feeding MusicAgentMemory, and the learnings feed.
const PLATFORM_META = {
      ...
      <div className="bg-card border border-border rounded-xl max-w-lg w-full my-8 overflow-hidden" onClick={e => e.stopPropagation()}>
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="flex gap-2">
            <Button type="button" onClick={handleSave} disabled={analyzing} className="flex-1 gradient-gold-button border-0 gap-2">
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h3 className="font-display text-xl font-bold gradient-gold-text">Content Performance</h3>
