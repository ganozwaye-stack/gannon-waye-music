...
// Lifted from src/pages/admin/GoogleDriveCommand.jsx — Drive file browser with
// search, folder breadcrumbs and pagination, plus the DriveSync last-synced badge.
const ACCENT = '#D4AF37';
...
export default function DriveBrowserPanel() {
  ...
  return (
    <div style={{ color: '#fff' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '24px', flexWrap: 'wrap', gap: '12px' }}>
        <div>
          <h3 style={{ margin: 0, fontSize: '18px', fontWeight: 700, color: '#f0e8d8', letterSpacing: '0.03em' }}>Google Drive</h3>
