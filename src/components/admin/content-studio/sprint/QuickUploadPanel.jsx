...
// Lifted from src/pages/admin/QuickUpload.jsx — drag-and-drop staging area for
// audio, artwork, and campaign press packages, with folders, search, and
// grid/list views.
export default function QuickUploadPanel() {
        ...
        <Card>
          <CardHeader className="pb-3 flex flex-row items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Layout togglers */}
              <Button type="button" variant="ghost" size="icon" className="h-8 w-8" onClick={() => setViewMode('grid')}>
                <Grid className={`w-4 h-4 ${viewMode === 'grid' ? 'text-primary' : ''}`} />
              </Button>
              <Button type="button" variant="ghost" size="icon" className="h-8 w-8" onClick={() => setViewMode('list')}>
