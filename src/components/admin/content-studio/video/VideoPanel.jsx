...
// Lifted from src/pages/admin/VideoManagement.jsx — TikTok/IG video embeds shown
// on the site, with the featured toggle for the Home page preview.
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
        <div>
          <h3 className="font-display text-xl text-foreground">Social Videos</h3>
          <p className="font-body text-sm text-muted-foreground mt-1">Manage Instagram Reels &amp; TikToks shown on your site</p>
        </div>
        <Button type="button" onClick={() => setShowForm(true)} className="gap-2 rounded-full font-body text-sm tracking-wider uppercase">
