...
// Lifted from src/pages/admin/MasteringAdmin.jsx — STATUS_CONFIG, the engineer
// review rows with analysis readouts, engineer notes and status updates.
const STATUS_CONFIG = {
          ...
          <div className="flex flex-wrap gap-3">
            {project.file_url && (
              <a href={project.file_url} target="_blank" rel="noopener noreferrer">
                <Button type="button" size="sm" variant="outline" className="gap-2 text-xs rounded-full">
            ...
            {project.mastered_file_url && (
              <a href={project.mastered_file_url} target="_blank" rel="noopener noreferrer">
                <Button type="button" size="sm" className="gap-2 text-xs rounded-full gradient-gold-button border-0">
...
export default function MasteringPanel() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="font-display text-xl text-foreground">Mastering Queue</h3>
