...
// Lifted from src/pages/admin/CoachingLeads.jsx — CoachingLead management,
// status colours, new-lead counter and lead intake history.
const STATUS_COLORS = {
...
export default function CoachingLeadsTab() {
        ...
        <div className="space-y-3">
          {filtered.map(lead => (
            <div key={lead.id} className="bg-card/50 border border-border/40 rounded-xl p-5 space-y-3">
              ...
              {lead.source_page && (
                <p className="font-body text-[10px] text-muted-foreground/40 font-mono">Source: {lead.source_page}</p>
              )}
