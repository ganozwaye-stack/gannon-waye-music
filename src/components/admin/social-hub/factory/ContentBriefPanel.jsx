...
// Lifted from src/pages/admin/SocialContentGenerator.jsx — the campaign-aware
// content brief generator with its tone, goal and footage configs.
const PLATFORMS = [
...
function CopyButton({ text }) {
  ...
  return (
    <button type="button" onClick={copy} className="flex items-center gap-1.5 font-body text-xs text-muted-foreground hover:text-foreground transition-colors">
...
Return JSON with these exact fields:
{
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="font-display text-lg text-foreground">Social Content Generator</h3>
      ...
      {result && (
        <div className="space-y-4">
          <div className="flex items-center justify-between flex-wrap gap-2">
            ...
            <Button type="button" variant="outline" size="sm" onClick={copyAll} className="rounded-full font-body text-xs gap-1.5">
