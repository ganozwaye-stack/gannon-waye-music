...
// Lifted from src/pages/admin/ReelFactory.jsx — SourceVideo + ReelClip flow
// through Opus Clip, clip review and approval-gated posting.
const PLATFORMS = [
...
export default function ReelFactoryPanel() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h3 className="font-display text-lg gradient-gold-text">Opus Clip → Reels → Approval</h3>
      ...
      <section>
        <h4 className="font-body text-xs tracking-[0.25em] uppercase text-muted-foreground mb-4">1 · Source videos</h4>
      ...
      <section>
        <h4 className="font-body text-xs tracking-[0.25em] uppercase text-muted-foreground mb-4">2 · Clips for review</h4>
        {clips.length === 0 && (
