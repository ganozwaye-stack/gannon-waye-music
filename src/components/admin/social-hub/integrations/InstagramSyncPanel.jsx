...
// Lifted from src/pages/admin/InstagramSync.jsx — direct post-to-Instagram flow.
export default function InstagramSyncPanel() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="font-display text-lg text-foreground">Instagram Sync</h3>
      ...
      <Card className="border-border/40">
        ...
        <CardContent className="space-y-4">
          <div>
            <label className="font-body text-xs tracking-wider uppercase text-muted-foreground mb-2 block">Image URL</label>
            <input
              type="url"
              value={imageUrl}
          ...
          <div>
            <label className="font-body text-xs tracking-wider uppercase text-muted-foreground mb-2 block">Caption</label>
            <textarea
              value={caption}
            ...
            />
            <p className="font-body text-[10px] text-muted-foreground/60 mt-1 text-right">{caption.length}/2200</p>
          </div>
          ...
          >
            {loading ? <>Posting...</> : <><Send className="w-3.5 h-3.5" /> Post to Instagram</>}
          </Button>
        </CardContent>
      </Card>
          ...
          <CardContent className="pt-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-body text-xs text-muted-foreground mt-1">Media ID: {lastPost.media_id}</p>
              </div>
            </div>
          </CardContent>
        </Card>
