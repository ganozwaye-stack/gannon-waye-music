...
const ACTIONS = [
  ...
  // CRITICAL
  {
    ...
    detail: 'Current product falls back to emoji placeholder. Cannot promote publicly without real mockup/artwork images. Upload via /admin/merch-designs → Poster product → Change Images.',
  ...
  // Content approvals — added by cross-platform dispatch
  {
    ...
    detail: 'The full merch collection ad (9:16 / 1:1 / 16:9) has been briefed. Canva/Adobe Express visual instructions are ready. Review brief at /admin/merch-content-briefs then approve in /admin/dashboard before Canva work begins.',
  ...
  },
  {
    ...
    detail: 'CapCut reel production requires actual product photo files: hoodie front/back, mug, tote, journal, pen, thermos flask, and lifestyle shots. Upload to /admin/content-studio → Merchandise folder.',
    link: '/admin/content-studio',
  ...
  },
  {
    ...
    detail: 'All 4 content pieces (merch ad + 3 reels) are DRAFT/NEEDS_REVIEW. Do not schedule in Metricool until: (1) brief approved in /admin/dashboard, (2) Canva/CapCut assets created, (3) Gannon gives final visual approval. Then and only then schedule via Metricool.',
