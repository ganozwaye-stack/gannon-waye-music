  ...
  const mockProducts = [
    {
      ...
      description: 'A premium dark grey hoodie from the Thankyou collection. The front carries the original Thankyou artwork, and the back features “Respect Is Earned — Not a Game You Make Me Play” with the Gannon Waye signature. Current owner-held stock is available in S, M, L and XL.',
      sale_price: 98,
      cost_price: 25,
      packaging_cost: 0,
      ...
      stock_verification_note: 'Owner confirmed on 4 September 2026 that no stock movement has occurred since the prior physical count: S 3, M 4, L 5, XL 2; total 14.',
    ...
    },
    {
      ...
      description: 'One complete boxed gift set containing one branded Respect Is Earned journal, one matching pen and one branded thermos, presented in a gift box. Current owner-confirmed stock is 19 complete sets. Delivery is calculated before payment.',
      sale_price: 59,
      cost_price: 10,
      packaging_cost: 0,
      merchant_fee_percent: 3.5,
      ...
      inventory_source: 'owned_stock',
      stock_verified_at: '2026-09-02T14:00:50.000Z',
      stock_verification_note: 'The physical count has not changed: 19 complete gift box sets. One sellable unit contains one branded journal, one matching pen, one branded thermos and one gift box. One sale deducts one complete set.',
      cost_verification_status: 'owner_approved_recorded_cost',
      cost_verification_note: 'Owner-approved recorded acquisition cost for stage one sale.',
      shipping_policy: 'customer_pays',
      exclude_from_discounts: true,
