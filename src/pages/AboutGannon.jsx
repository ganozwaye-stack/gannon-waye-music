...
const STORY_PARAGRAPHS = [
  "I was born and raised in Adelaide, one of four kids, and I've called Melbourne home for over 13 years now.",
  "Music has always been there. From a young age, I was singing at every opportunity — family events, competitions, anywhere I could be heard. Even when it wasn't always encouraged, I still showed up. That never left me.",
  ...
  "I spent years feeling like I had to be someone else just to be accepted. I didn't truly like or love myself until I was 33. That moment changed everything. It was the first time I felt free from the fear of abandonment, and it shifted how I saw my entire life.",
  "There has been a lot of loss in my world. Losing my ex-partner to suicide, losing my mum — who was my best friend — these moments didn't just hurt, they reshaped me. Grief is something I'm still learning to sit with. Some days it feels further away, other days it feels impossible to process at all.",
  "At one point, I turned to drugs trying to navigate that pain. What followed was a long recovery journey — one that forced me to look inward, understand myself, and rebuild from the ground up. Over six years, I developed emotional awareness, regulation, and a sense of purpose I never had before.",
  "Now, everything I create comes from that place. My music is not just sound — it's lived experience. It's for anyone who has ever felt lost, isolated, or like they didn't belong.",
  "If even one person hears something in my music that helps them feel understood — that's everything.",
];
