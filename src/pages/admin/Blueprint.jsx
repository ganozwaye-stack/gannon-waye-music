...
const PAGES = [
  ...
  { label: 'Newsletter', path: '/admin/release-email-studio', admin: true },
  ...
  { label: 'Promo Codes', path: '/admin/financials', admin: true },
      ...
      <Section icon={CheckSquare} title="Pre-Launch Owner Checklist" count={7} color="bg-green-500/10 text-green-400">
        <div className="space-y-3">
          ...
          {[
            ...
            { item: 'Submit a test subscriber signup and verify welcome email sends or logs expected sandbox note', note: 'Check /admin/dashboard after signup' },
