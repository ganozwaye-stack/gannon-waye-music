...
const CODE_PACKS = [
  ...
  },
  {
    ...
    files: [
      ...
      { path: 'components/admin/merch-family/Orders.jsx', desc: 'Order management' },
      { path: 'components/admin/merch-family/MerchManagement.jsx', desc: 'Product management' },
      ...
      { path: 'components/admin/merch-family/BundleProposalStudio.jsx', desc: 'Bundle builder' },
      { path: 'components/admin/financials/RevenueActions.jsx', desc: 'Revenue action proposals' },
      ...
      { path: 'components/admin/financials/PromoCodes.jsx', desc: 'Promo code management' },
      { path: 'components/admin/merch-family/ShippingRates.jsx', desc: 'Shipping rate rules' },
      { path: 'components/admin/financials/StripeCommandCentreNew.jsx', desc: 'Stripe health dashboard' },
      { path: 'pages/admin/PaymentDiagnosticsNew.jsx', desc: 'Payment issue tracker' },
      { path: 'components/admin/financials/WebhookHealthNew.jsx', desc: 'Webhook monitoring' },
  ...
  },
  {
    ...
    files: [
      ...
      { path: 'components/admin/agent-workbench/AgentRegistry.jsx', desc: 'Agent registry' },
      ...
      { path: 'components/admin/agent-workbench/AgentIntelligence.jsx', desc: 'Agent performance' },
      { path: 'components/admin/agent-workbench/AgentLearning.jsx', desc: 'Agent learning records' },
      { path: 'components/admin/agent-workbench/OrchestratorChat.jsx', desc: 'Orchestrator chat UI' },
      { path: 'components/admin/dashboard-family/ApprovalQueue.jsx', desc: 'Approval queue' },
      { path: 'pages/admin/Notifications.jsx', desc: 'Business Attention Centre' },
      { path: 'components/admin/ideas-family/KnowledgeVault.jsx', desc: 'Knowledge vault' },
      { path: 'pages/admin/RiskAlerts.jsx', desc: 'Risk alert tracker' },
      { path: 'components/admin/agent-workbench/MemoryGraph.jsx', desc: 'Agent memory graph' },
      { path: 'pages/admin/IdeasEngine.jsx', desc: 'Ideas engine' },
      { path: 'components/admin/ideas-family/GrowthEngine.jsx', desc: 'Growth opportunity engine' },
      { path: 'components/admin/ideas-family/ResearchHub.jsx', desc: 'Research hub' },
      { path: 'components/admin/ideas-family/ResearchGrid.jsx', desc: 'Research grid' },
      { path: 'components/admin/dashboard-family/AtoZIndex.jsx', desc: 'A-Z index of all pages' },
    ],
  ...
  },
  {
    ...
    files: [
      ...
      { path: 'components/admin/release-studio/Releases.jsx', desc: 'Release management' },
  ...
  },
  {
    ...
    files: [
      ...
      { path: 'components/admin/qa-family/PlaywrightTestCentre.jsx', desc: 'Playwright test pack downloads' },
      ...
      { path: 'components/admin/qa-family/ChatGPTCodeReviewExport.jsx', desc: 'ChatGPT upload guide' },
      { path: 'components/admin/qa-family/SiteFunctionAudit.jsx', desc: 'Site function audit' },
