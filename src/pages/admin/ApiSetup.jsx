...
const PLATFORMS = [
  ...
  { platform_name: 'Too Lost', category: 'distribution', purpose: 'Music distribution, royalty tracking and release delivery', developer_account_required: true, api_key_required: false, oauth_required: true, approval_required: true, risk_level: 'medium', human_action_required: 'Sign in only in the separate official Too Lost OAuth window. Keep your password and verification codes private. Too Lost must approve the production developer app.', permissions_needed: ['read:profile', 'read:releases', 'write:releases'], setup_steps: ['Open developer.toolost.com and create or confirm a confidential OAuth app', 'Register the exact callback URL saved as TOO_LOST_REDIRECT_URI', 'Save the client ID and client secret in Base44 Secrets', 'Open Distributor Hub and choose Connect Too Lost', 'Complete login and approval in the separate Too Lost window'] },
