...
const PLATFORMS = [
  ...
  { platform_name: 'PostHog', category: 'analytics', purpose: 'Product analytics, user behaviour tracking, funnels', developer_account_required: false, api_key_required: true, oauth_required: false, approval_required: false, risk_level: 'low', human_action_required: 'Create PostHog account at posthog.com, get project API key from Settings', permissions_needed: ['events.read', 'persons.read'], setup_steps: ['Sign up at posthog.com', 'Create project', 'Go to Settings → Project API Key', 'Add POSTHOG_API_KEY to environment'] },
