...
const SECTIONS = [
  ...
  { id: 8, title: 'Content Engine', owner: 'agents', status: 'AWAITING GANNON REVIEW + TIMESTAMP CONFIRMATION', nextAction: '1. Gannon provides exact audio timestamps. 2. Review 21 posts in ApprovalQueue. 3. Approve individually.', blocker: 'TIMESTAMPS NOT CONFIRMED. Do not schedule. Do not move to Metricool.', latestResult: 'ContentPost, ContentCalendarPost entities. generateDailyDrafts function. 21 campaign posts drafted.', items: ['ContentPost entity', 'ContentCalendarPost entity', 'generateDailyDrafts function', '21 campaign posts in ApprovalQueue'] },
  { id: 9, title: 'Metricool Scheduling', owner: 'Gannon', status: 'BLOCKED UNTIL APPROVAL + TIMESTAMPS + PROFILE CONFIRMATION', nextAction: 'Confirm Metricool profile ID in /admin/metricool-api-setup. Test schedule 1 post.', blocker: 'METRICOOL_BLOG_ID profile mapping not confirmed', latestResult: 'metricoolSchedulePost, metricoolDiagnostics functions deployed.', items: ['metricoolSchedulePost function', 'MetricoolApiSetup admin page'] },
