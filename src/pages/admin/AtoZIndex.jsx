...
const ALL_PAGES = [
  ...
  { label: 'Social Command', route: '/admin/social-schedule-queue', category: 'Social' },
  { label: 'Social Content Generator', route: '/admin/social-schedule-queue', category: 'Social' },
  { label: 'Social Distribution Readiness', route: '/admin/social-distribution-readiness', category: 'Social' },
  { label: 'Social Intelligence', route: '/admin/social-schedule-queue', category: 'Social' },
  { label: 'Social Monitor', route: '/admin/social-schedule-queue', category: 'Social' },
