...
const ADMIN_SECTIONS = [
  {
    ...
    routes: [
      ...
      { path: '/admin/agent-workbench', name: 'Orchestrator AI' },
    ],
  },
  {
    section: 'Commerce',
    routes: [
      { path: '/admin/merch-designs', name: 'Orders' },
      { path: '/admin/order-profit-intelligence', name: 'Order Profit Intelligence' },
      { path: '/admin/merch-designs', name: 'Products' },
      { path: '/admin/financials', name: 'Promo Codes' },
      { path: '/admin/financials', name: 'Promo Code Audit' },
      { path: '/admin/merch-designs', name: 'Bundle Proposal Studio' },
      { path: '/admin/content-studio', name: 'Content to Cash' },
      { path: '/admin/ecommerce-command', name: 'Ecommerce Command' },
      { path: '/admin/fan-conversion-engine', name: 'Fan Conversion Engine' },
      { path: '/admin/merch-designs', name: 'Merch Financials' },
      { path: '/admin/offer-engine', name: 'Offer Engine' },
      { path: '/admin/product-insights', name: 'Product Insights' },
      { path: '/admin/financials', name: 'Revenue Actions' },
      { path: '/admin/financials', name: 'Revenue Command' },
      { path: '/admin/merch-designs', name: 'Shipping Rates' },
      { path: '/admin/stripe-live-report', name: 'Stripe Live Report' },
      { path: '/admin/financials', name: 'Stripe Command Centre' },
      { path: '/admin/financials', name: 'Webhook Health' },
  ...
  },
  {
    ...
    routes: [
      ...
      { path: '/admin/social-schedule-queue', name: 'Metricool Media Pipeline' },
      ...
      { path: '/admin/social-schedule-queue', name: 'Social Asset Library' },
      { path: '/admin/social-schedule-queue', name: 'Social Post Factory' },
      { path: '/admin/content-quality-review', name: 'Content Quality Review' },
      { path: '/admin/social-schedule-queue', name: 'Social Schedule Queue' },
      { path: '/admin/content-studio', name: 'Content Performance' },
      { path: '/admin/social-schedule-queue', name: 'Social Content Generator' },
      ...
      { path: '/admin/social-schedule-queue', name: 'Social Intelligence' },
  ...
  },
  {
    ...
    routes: [
      { path: '/admin/agent-workbench', name: 'Agent Intelligence' },
      { path: '/admin/agent-capability-matrix', name: 'Agent Capability Matrix' },
      { path: '/admin/agent-workbench', name: 'Agent Registry' },
      { path: '/admin/agent-workbench', name: 'Agent Task Log' },
      { path: '/admin/agent-workbench', name: 'Agent Learning' },
      { path: '/admin/ideas-engine', name: 'Knowledge Vault' },
      { path: '/admin/ideas-engine', name: 'Research Grid' },
      { path: '/admin/ideas-engine', name: 'Research Hub' },
      { path: '/admin/agent-workbench', name: 'Memory Graph' },
      { path: '/admin/ideas-engine', name: 'Ideas Engine' },
      { path: '/admin/operational-status', name: 'Autonomous Ops' },
      { path: '/admin/dashboard', name: 'A-Z Index' },
  ...
  },
  {
    ...
    routes: [
      { path: '/admin/release-email-studio', name: 'Releases' },
      { path: '/admin/music-command', name: 'Music Command' },
      { path: '/admin/release-email-studio', name: 'Release Countdown' },
      { path: '/admin/content-studio', name: 'Video Management' },
      { path: '/admin/content-studio', name: 'Mastering Admin' },
  ...
  },
  {
    ...
    routes: [
      ...
      { path: '/admin/dashboard', name: 'Subscribers' },
      { path: '/admin/release-email-studio', name: 'Newsletter' },
      { path: '/admin/fan-media', name: 'Fan Media' },
      { path: '/admin/merch-designs', name: 'Gift Claims' },
      { path: '/admin/merch-designs', name: 'Gift Progress' },
      { path: '/admin/merch-designs', name: 'Gift Verification' },
      { path: '/admin/merch-designs', name: 'Merch Feedback' },
  ...
  },
  {
    ...
    routes: [
      ...
      { path: '/admin/qa-command-centre', name: 'Playwright Tests' },
      { path: '/admin/developer-handoff', name: 'Developer Handoff' },
      { path: '/admin/qa-command-centre', name: 'Site Function Audit' },
      { path: '/admin/operation-registry', name: 'Operation Registry' },
      { path: '/admin/code-audit-export', name: 'Code Audit Export' },
      { path: '/admin/qa-command-centre', name: 'ChatGPT Code Review Export' },
      { path: '/admin/qa-failure-report', name: 'QA Failure Report' },
      { path: '/admin/qa-command-centre', name: 'Voice Input Test' },
    ...
    <div className="space-y-6 pb-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          { label: 'Active Orders', value: orders.filter(o => !['cancelled','refunded'].includes(o.status)).length, icon: Package, color: 'text-primary', to: '/admin/merch-designs' },
          { label: 'Products', value: products.length, icon: ShoppingBag, color: 'text-foreground', to: '/admin/merch-designs' },
          { label: 'Subscribers', value: subscribers.length, icon: Users, color: 'text-chart-2', to: '/admin/dashboard' },
          { label: 'Pending Approvals', value: approvals.length, icon: CheckCircle2, color: approvals.length > 0 ? 'text-primary' : 'text-muted-foreground', to: '/admin/dashboard' },
          { label: 'Agents', value: agents.length, icon: Bot, color: 'text-purple-400', to: '/admin/agent-workbench' },
