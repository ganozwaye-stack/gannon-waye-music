...
const PRODUCTS = [
  {
    ...
    whereOnSite: '/admin/social-schedule-queue → Step 2 & 3',
    missing: null,
  },
  {
    ...
    whereOnSite: '/admin/social-schedule-queue → Step 5, 6, 7',
    missing: null,
  },
  {
    name: 'Share Kit',
      ...
      <Card>
        ...
        <CardContent className="flex flex-wrap gap-2">
          {[
            ...
            { label: 'TikTok Review Demo (10-step)', url: '/admin/social-schedule-queue' },
