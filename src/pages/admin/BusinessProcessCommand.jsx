...
export default function BusinessProcessCommand() {
  ...
  const commandLinks = [
    ...
    { label: 'Orders', path: '/admin/merch-designs', icon: ShoppingCart, desc: 'Customer orders · Fulfillment' },
    { label: 'Merch Management', path: '/admin/merch-designs', icon: Package, desc: 'Products · Prices · Stock' },
    { label: 'Merch Financials', path: '/admin/merch-designs', icon: BarChart3, desc: 'Profit · Margins · Revenue' },
    ...
    { label: 'Shipping Rates', path: '/admin/merch-designs', icon: Truck, desc: 'Postage rules' },
    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          { label: 'Customer Orders', value: pendingOrders.length, color: 'text-green-400', path: '/admin/merch-designs' },
          { label: 'Products Needing Images', value: noImageProducts.length, color: 'text-orange-400', path: '/admin/merch-designs' },
          { label: 'Active Products', value: products.filter(p => p.is_active).length, color: 'text-green-400', path: '/admin/merch-designs' },
        ].map(s => (
