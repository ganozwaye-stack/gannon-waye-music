...
<div style="max-width:600px;margin:0 auto;padding:40px 24px;">
  ...
  <p style="color:#c9b99a;font-size:15px;line-height:1.8;">You'll receive community updates, creative news, and any music announcements that Gannon has explicitly approved for public release. Nothing here assumes a song title, date, or release status.</p>
