...
<div style="max-width:620px;margin:0 auto;padding:40px 24px;">
  ...
  <p style="color:#c9b99a;font-size:15px;line-height:1.8;">I've been counting down to this moment for a long time. And now, here we are.</p>

  <div style="background:#1a1f2e;border:1px solid #2a2f3e;border-radius:16px;padding:28px;margin:28px 0;text-align:center;">
    <p style="color:#f5d06e;font-size:13px;letter-spacing:0.25em;text-transform:uppercase;margin:0 0 8px;">Artwork is Live</p>
    <p style="font-size:32px;color:#f0ead6;font-style:italic;margin:0 0 8px;">"Thank You"</p>
    <p style="color:#999;font-size:13px;margin:0 0 20px;">Releases June 10, 2026</p>
    <a href="https://gannonwaye.com" style="display:inline-block;background:#f5d06e;color:#0e1117;padding:13px 30px;border-radius:50px;text-decoration:none;font-weight:700;font-size:14px;">See the artwork →</a>
  </div>
  ...
  <p style="color:#c9b99a;font-size:15px;line-height:1.8;">Pre-orders are open now at the store — and the first 20 orders get <strong style="color:#f5d06e;">15% off with code LAUNCH15</strong>.</p>
  ...
  try {
    ...
    for (const sub of subscribers) {
      ...
      const res = await fetch('https://gmail.googleapis.com/gmail/v1/users/me/messages/send', {
        ...
        body: JSON.stringify({ raw: buildMimeMessage({ to: sub.email, subject: `🎶 The moment is here. "Thank You" — Artwork Reveal & Release Date`, htmlBody: html }) })
      });
