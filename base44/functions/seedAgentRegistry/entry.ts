...
const AGENTS = [
  ...
  { agent_name: "Stream Growth Campaign Manager", group: "marketing", purpose: "Manages stream, save, share, and playlist growth for active releases", status: "active", approval_level: "always_approve", financial_risk: "none", legal_risk: "none", reputation_risk: "low" },
