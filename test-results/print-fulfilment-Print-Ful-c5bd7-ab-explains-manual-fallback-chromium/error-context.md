...
- Name: print-fulfilment.spec.js >> Print Fulfilment Admin Page >> Order Routing tab explains manual fallback
- Location: src/gannonwaye-playwright-pack/tests/print-fulfilment.spec.js:61:7
...
Call log:
  - waiting for locator('button:has-text("Order Routing")')
