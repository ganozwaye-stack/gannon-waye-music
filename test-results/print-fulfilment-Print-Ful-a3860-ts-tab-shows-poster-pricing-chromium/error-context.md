...
- Name: print-fulfilment.spec.js >> Print Fulfilment Admin Page >> Size variants tab shows poster pricing
- Location: src/gannonwaye-playwright-pack/tests/print-fulfilment.spec.js:41:7
...
Call log:
  - waiting for locator('button:has-text("Size Variants")')
