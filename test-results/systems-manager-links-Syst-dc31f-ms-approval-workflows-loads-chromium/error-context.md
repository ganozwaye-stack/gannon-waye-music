...
- Name: systems-manager-links.spec.js >> Systems Manager — service destination pages load >> /systems/approval-workflows loads
...
Received string: "
    Support Now404Page Not FoundThe page \"systems/approval-workflows\" could not be found.Go Home
...
- paragraph: The page "systems/approval-workflows" could not be found.
- button "Go Home"
```
