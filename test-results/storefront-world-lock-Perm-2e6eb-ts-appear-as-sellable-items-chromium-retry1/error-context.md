...
- Name: storefront-world-lock.spec.js >> Permanent boutique world and verified store >> only the two approved stage one products appear as sellable items
- Location: src/gannonwaye-playwright-pack/tests/storefront-world-lock.spec.js:25:7
...
- generic [ref=e3]:
  ...
  - generic [ref=e243]:
    - img [ref=e244]
    - paragraph [ref=e246]: 🎶Follow the story through music and creative updates
