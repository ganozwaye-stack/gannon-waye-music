...
- Name: mum-tribute.spec.js >> Mum Tribute Page >> A Letter To Mum section present
- Location: src/gannonwaye-playwright-pack/tests/mum-tribute.spec.js:147:3
...
Locator: locator('text=A Letter To Mum').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=A Letter To Mum').first()
