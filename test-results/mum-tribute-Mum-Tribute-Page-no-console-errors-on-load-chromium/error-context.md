...
- Name: mum-tribute.spec.js >> Mum Tribute Page >> no console errors on load
- Location: src/gannonwaye-playwright-pack/tests/mum-tribute.spec.js:172:3
...
Expected length: 0
Received length: 2
Received array:  ["Failed to load resource: the server responded with a status of 404 (Not Found)", "[Base44 SDK Error] 404: Request failed with status code 404"]
```
...
- generic [ref=e2]:
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e271]:
      - img [ref=e272]
      - paragraph [ref=e274]: 🎵Music approved for public sharing appears on the Music page
