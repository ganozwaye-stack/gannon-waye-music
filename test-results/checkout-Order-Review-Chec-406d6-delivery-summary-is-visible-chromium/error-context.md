...
- Name: checkout.spec.js >> Order Review / Checkout Page >> delivery summary is visible
- Location: src/gannonwaye-playwright-pack/tests/checkout.spec.js:67:3
...
Locator: locator('[data-testid="checkout-delivery-summary"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="checkout-delivery-summary"]')
