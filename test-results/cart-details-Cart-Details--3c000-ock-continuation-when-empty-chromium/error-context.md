...
- Name: cart-details.spec.js >> Cart Details Page >> required fields block continuation when empty
- Location: src/gannonwaye-playwright-pack/tests/cart-details.spec.js:45:3
...
Call log:
  - waiting for locator('[data-testid="continue-to-review-button"]')
...
- generic [ref=e3]:
  ...
  - generic [ref=e174]:
    - img [ref=e175]
    - paragraph [ref=e177]: 🎶Follow the story through music and creative updates
