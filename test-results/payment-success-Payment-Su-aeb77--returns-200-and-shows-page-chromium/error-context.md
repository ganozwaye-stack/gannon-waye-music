...
- Name: payment-success.spec.js >> Payment Success & Cancel Routes >> /store/checkout-success returns 200 and shows page
- Location: src/gannonwaye-playwright-pack/tests/payment-success.spec.js:15:3
...
- paragraph: The page "store/checkout-success" could not be found.
- button "Go Home"
```
