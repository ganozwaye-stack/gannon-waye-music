...
- Name: checkout.spec.js >> Order Review / Checkout Page >> customer summary is visible
- Location: src/gannonwaye-playwright-pack/tests/checkout.spec.js:61:3
...
Locator: locator('[data-testid="checkout-customer-summary"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="checkout-customer-summary"]')
