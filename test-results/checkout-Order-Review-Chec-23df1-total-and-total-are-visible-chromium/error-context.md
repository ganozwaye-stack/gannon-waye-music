...
- Name: checkout.spec.js >> Order Review / Checkout Page >> subtotal and total are visible
- Location: src/gannonwaye-playwright-pack/tests/checkout.spec.js:170:3
...
Locator: locator('[data-testid="checkout-subtotal"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="checkout-subtotal"]')
