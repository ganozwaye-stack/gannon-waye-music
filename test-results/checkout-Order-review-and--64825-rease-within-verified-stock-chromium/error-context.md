...
- Name: checkout.spec.js >> Order review and checkout page >> customer can increase and decrease within verified stock
- Location: src/gannonwaye-playwright-pack/tests/checkout.spec.js:56:3
