...
- Name: merch-product-fixes.spec.js >> Merch store — product pricing >> Winter bundle add to cart button is visible
- Location: src/gannonwaye-playwright-pack/tests/merch-product-fixes.spec.js:37:7
...
Locator: locator('[data-testid="winter-bundle-add-to-cart"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="winter-bundle-add-to-cart"]')
