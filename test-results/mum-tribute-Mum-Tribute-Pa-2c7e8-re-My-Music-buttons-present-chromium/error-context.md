...
- Name: mum-tribute.spec.js >> Mum Tribute Page >> Back Home and Explore My Music buttons present
- Location: src/gannonwaye-playwright-pack/tests/mum-tribute.spec.js:159:3
...
Locator: locator('text=Back Home').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Back Home').first()
