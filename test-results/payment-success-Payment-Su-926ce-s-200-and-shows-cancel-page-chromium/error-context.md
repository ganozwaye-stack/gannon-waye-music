...
- Name: payment-success.spec.js >> Payment Success & Cancel Routes >> /store/checkout-cancel returns 200 and shows cancel page
- Location: src/gannonwaye-playwright-pack/tests/payment-success.spec.js:39:3
...
Locator: locator('text=Checkout Cancelled')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Checkout Cancelled')
...
- paragraph: The page "store/checkout-cancel" could not be found.
- button "Go Home"
```
