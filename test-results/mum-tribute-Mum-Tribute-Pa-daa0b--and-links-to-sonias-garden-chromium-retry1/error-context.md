...
- Name: mum-tribute.spec.js >> Mum Tribute Page >> Hear Her Wisdom button is visible and links to #sonias-garden
- Location: src/gannonwaye-playwright-pack/tests/mum-tribute.spec.js:66:3
...
Locator: locator('text=Hear Her Wisdom').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Hear Her Wisdom').first()
