...
- A4
+
+     GWHomeBiographyMusicStoreMum's GardenPressContactMore Boutique · Step InsideGannon WayeMerch StoreStep inside the boutiqueThe owner approved collectionThe boutique world is permanent. Prices, stock and purchasing come only from verified live records.Available"Respect Is Earned" Hoodie — Dark Grey$98.00 AUD14 in stockAvailableThank You Journal Pen and Thermos Flask Bundle$59.00 AUD19 in stockAvailable nowShop the collectionCurrent owner-approved stock is available for delivery within Australia.Prices are in AUD. Delivery is shown before payment. Gannon Waye Music ABN 22 931 809 349. No GST is charged.MerchAvailable Now"Respect Is Earned" Hoodie — Dark Grey$98 AUDOwner-counted stock in S, M, L and XL. Delivery is calculated before payment.S (3)M (4)L (5)XL (2) Add to CartIn StockThank You Journal Pen and Thermos Flask Bundle$59 AUDJournal, pen and thermos flask set. Delivery is calculated before payment. Add to CartIndependent music, merchandise, and community support.GWAustralian singer songwriter sharing emotionally honest music, stories, and current merchandise.NavigateHomeBiographyMusicLyricsStorePressMum TributeContactContactFor music, media, collaboration, and business enquiriesgannonwayemusic@gmail.comLegalPrivacy PolicyTerms of ServiceSocialInstagram @gann0nwayeTikTok @gann0nwayeYouTube @gannonwayeofficialStay connectedMusic and merchandise updatesI would like to receive music and merchandise updates. I can unsubscribe at any time.Join the Update ListGannon Waye Music · ABN 22 931 809 349 · No GST is charged.© 2026 Gannon Waye. All rights reserved.HomeMusicStoreLyricsContact🖤Independent, emotionally honest music from Gannon Waye
+     
+     
+     
+   
...
Call log:
  ...
  - waiting for locator('body')
    14 × locator resolved to <body>…</body>
       - unexpected value "
    GWHomeBiographyMusicStoreMum's GardenPressContactMore Boutique · Step InsideGannon WayeMerch StoreStep inside the boutiqueThe owner approved collectionThe boutique world is permanent. Prices, stock and purchasing come only from verified live records.Available"Respect Is Earned" Hoodie — Dark Grey$98.00 AUD14 in stockAvailableThank You Journal Pen and Thermos Flask Bundle$59.00 AUD19 in stockAvailable nowShop the collectionCurrent owner-approved stock is available for delivery within Australia.Prices are in AUD. Delivery is shown before payment. Gannon Waye Music ABN 22 931 809 349. No GST is charged.MerchAvailable Now"Respect Is Earned" Hoodie — Dark Grey$98 AUDOwner-counted stock in S, M, L and XL. Delivery is calculated before payment.S (3)M (4)L (5)XL (2) Add to CartIn StockThank You Journal Pen and Thermos Flask Bundle$59 AUDJournal, pen and thermos flask set. Delivery is calculated before payment. Add to CartIndependent music, merchandise, and community support.GWAustralian singer songwriter sharing emotionally honest music, stories, and current merchandise.NavigateHomeBiographyMusicLyricsStorePressMum TributeContactContactFor music, media, collaboration, and business enquiriesgannonwayemusic@gmail.comLegalPrivacy PolicyTerms of ServiceSocialInstagram @gann0nwayeTikTok @gann0nwayeYouTube @gannonwayeofficialStay connectedMusic and merchandise updatesI would like to receive music and merchandise updates. I can unsubscribe at any time.Join the Update ListGannon Waye Music · ABN 22 931 809 349 · No GST is charged.© 2026 Gannon Waye. All rights reserved.HomeMusicStoreLyricsContact🎵Approved music and official listening links appear on the Music page
