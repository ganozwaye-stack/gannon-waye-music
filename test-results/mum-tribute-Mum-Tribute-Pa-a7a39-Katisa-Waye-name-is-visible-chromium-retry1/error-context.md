...
- Name: mum-tribute.spec.js >> Mum Tribute Page >> Sonia Katisa Waye name is visible
- Location: src/gannonwaye-playwright-pack/tests/mum-tribute.spec.js:39:3
...
Locator: locator('text=Sonia Katisa Waye').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Sonia Katisa Waye').first()
