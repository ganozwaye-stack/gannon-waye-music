...
- Name: store-load.spec.js >> Store Load & Product Cards >> product titles are visible
- Location: src/gannonwaye-playwright-pack/tests/store-load.spec.js:23:3
...
Locator: locator('[data-testid="product-title"]').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="product-title"]').first()
