...
- Name: src\gannonwaye-playwright-pack\tests\store-load.spec.js >> Store Load & Product Cards >> product images are visible
- Location: src\gannonwaye-playwright-pack\tests\store-load.spec.js:17:3
