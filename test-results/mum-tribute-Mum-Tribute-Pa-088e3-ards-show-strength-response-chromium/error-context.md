...
- Name: mum-tribute.spec.js >> Mum Tribute Page >> wisdom cards show strength response
- Location: src/gannonwaye-playwright-pack/tests/mum-tribute.spec.js:123:3
...
Call log:
  - waiting for locator('button:has-text("I need strength")').first()
...
- generic [ref=e2]:
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e271]:
      - img [ref=e272]
      - paragraph [ref=e274]: 🛍️Visit the Store for official merch and supporter items
