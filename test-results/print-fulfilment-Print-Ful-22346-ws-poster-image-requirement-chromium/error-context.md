...
- Name: print-fulfilment.spec.js >> Print Fulfilment Admin Page >> Human Action Required tab shows poster image requirement
- Location: src/gannonwaye-playwright-pack/tests/print-fulfilment.spec.js:54:7
...
Call log:
  - waiting for locator('button:has-text("Human Action Required")')
