...
- Name: src\gannonwaye-playwright-pack\tests\cart.spec.js >> Cart Flow >> sticky checkout bar appears when cart has items
- Location: src\gannonwaye-playwright-pack\tests\cart.spec.js:87:3
