...
- Name: mum-tribute.spec.js >> Mum Tribute Page >> heart of gold emblem is present
- Location: src/gannonwaye-playwright-pack/tests/mum-tribute.spec.js:58:3
...
Locator: locator('.memorial-heart').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('.memorial-heart').first()
