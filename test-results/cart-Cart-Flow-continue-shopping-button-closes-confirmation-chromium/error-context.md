...
- Name: cart.spec.js >> Cart Flow >> continue shopping button closes confirmation
- Location: src/gannonwaye-playwright-pack/tests/cart.spec.js:47:3
...
Call log:
  - waiting for locator('[data-testid="continue-shopping-button"]').first()
