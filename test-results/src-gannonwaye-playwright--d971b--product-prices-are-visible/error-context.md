...
- Name: src\gannonwaye-playwright-pack\tests\store-load.spec.js >> Store Load & Product Cards >> product prices are visible
- Location: src\gannonwaye-playwright-pack\tests\store-load.spec.js:27:3
