...
- Name: checkout.spec.js >> Order Review / Checkout Page >> customer can remove item
- Location: src/gannonwaye-playwright-pack/tests/checkout.spec.js:95:3
...
Call log:
  - waiting for locator('[data-testid="cart-line-remove"]').first()
