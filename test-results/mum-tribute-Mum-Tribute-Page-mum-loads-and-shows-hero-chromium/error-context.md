...
- Name: mum-tribute.spec.js >> Mum Tribute Page >> /mum loads and shows hero
...
Call log:
  ...
  - waiting for locator('h1')
    20 × locator resolved to <h1 data-dynamic-content="true" data-source-location="src/components/mums-garden/scenes/HeavenlyArrival.jsx:45:8" class="font-cormorant text-[clamp(3rem,8vw,6.5rem)] leading-none text-[hsl(var(--garden-cream))]">Sonia’s Garden</h1>
