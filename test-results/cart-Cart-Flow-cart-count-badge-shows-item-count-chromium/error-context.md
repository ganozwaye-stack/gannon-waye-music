...
- Name: cart.spec.js >> Cart Flow >> cart count badge shows item count
- Location: src/gannonwaye-playwright-pack/tests/cart.spec.js:128:3
...
Locator: locator('[data-testid="cart-count"]')
Expected: visible
Timeout: 3000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="cart-count"]')
