...
- Name: checkout.spec.js >> Order review and checkout page >> checkout page loads with verified cart item and summaries
- Location: src/gannonwaye-playwright-pack/tests/checkout.spec.js:48:3
