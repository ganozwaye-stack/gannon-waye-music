...
- Name: mum-tribute.spec.js >> Mum Tribute Page >> disclaimer (Not medical) is visible
- Location: src/gannonwaye-playwright-pack/tests/mum-tribute.spec.js:139:3
...
Locator: locator('text=Not medical').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Not medical').first()
