...
- Name: checkout.spec.js >> Order Review / Checkout Page >> pay button is visible and enabled
- Location: src/gannonwaye-playwright-pack/tests/checkout.spec.js:176:3
...
Locator: locator('[data-testid="checkout-pay-button"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="checkout-pay-button"]')
