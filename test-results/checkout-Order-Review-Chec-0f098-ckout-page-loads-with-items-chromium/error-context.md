...
- Name: checkout.spec.js >> Order Review / Checkout Page >> checkout page loads with items
- Location: src/gannonwaye-playwright-pack/tests/checkout.spec.js:55:3
...
Locator: locator('[data-testid="checkout-items"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="checkout-items"]')
