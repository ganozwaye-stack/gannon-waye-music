...
- Name: systems-manager-links.spec.js >> Systems Manager — service destination pages load >> /systems/ecommerce-merch-stores loads
...
Received string: "
    Support Now404Page Not FoundThe page \"systems/ecommerce-merch-stores\" could not be found.Go Home
...
- paragraph: The page "systems/ecommerce-merch-stores" could not be found.
- button "Go Home"
```
