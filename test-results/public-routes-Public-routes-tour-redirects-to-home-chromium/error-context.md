...
- Location: src/gannonwaye-playwright-pack/tests/public-routes.spec.js:30:7
...
Expected: "https://gannonwaye.com/"
Received: "https://gannonwaye.com/tour"
Timeout:  10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    23 × unexpected value "https://gannonwaye.com/tour"

```

```yaml
- button "Open site music player":
  - img
  - text: Now playing on site Without You Here by Gannon Waye
- img
- paragraph: Support the Thankyou Project
- paragraph: Help fund independent music directly
- button "Show player":
  - img
- link "Impact":
  - /url: /impact
...
- paragraph: The page "tour" could not be found.
- button "Go Home"
```
