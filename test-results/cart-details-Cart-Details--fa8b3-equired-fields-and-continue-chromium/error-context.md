...
- Name: cart-details.spec.js >> Cart Details Page >> customer can fill all required fields and continue
- Location: src/gannonwaye-playwright-pack/tests/cart-details.spec.js:59:3
...
- generic [ref=e3]:
  ...
  - generic [ref=e174]:
    - img [ref=e175]
    - paragraph [ref=e177]: 🎵Approved music and official listening links appear on the Music page
