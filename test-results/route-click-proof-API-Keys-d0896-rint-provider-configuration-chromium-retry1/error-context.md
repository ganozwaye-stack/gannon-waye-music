...
[data-side=right] .\\[\\[data-side\\=right\\]_\\&\\]\\:cursor-e-resize{
  ...
  <body>
    <div id=\"root\"><div data-source-location=\"src/components/AuthLayout.jsx:3:4\" data-dynamic-content=\"true\" class=\"min-h-screen flex items-center justify-center bg-background px-4\"><div data-source-location=\"src/components/AuthLayout.jsx:4:6\" data-dynamic-content=\"true\" class=\"w-full max-w-md\"><div data-source-location=\"src/components/AuthLayout.jsx:5:8\" data-dynamic-content=\"true\" class=\"text-center mb-10\"><div data-source-location=\"src/components/AuthLayout.jsx:6:10\" data-dynamic-content=\"false\" class=\"inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-primary mb-4\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" class=\"lucide lucide-log-in w-7 h-7 text-primary-foreground\" data-source-location=\"src/components/AuthLayout.jsx:7:12\" data-dynamic-content=\"false\" aria-hidden=\"true\"><path d=\"M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4\"></path><polyline points=\"10 17 15 12 10 7\"></polyline><line x1=\"15\" x2=\"3\" y1=\"12\" y2=\"12\"></line></svg></div><h1 data-source-location=\"src/components/AuthLayout.jsx:9:10\" data-dynamic-content=\"true\" class=\"text-3xl font-bold tracking-tight text-foreground\" data-collection-item-field=\"title\">Owner sign-in</h1><p data-source-location=\"src/components/AuthLayout.jsx:10:23\" data-dynamic-content=\"true\" class=\"text-muted-foreground mt-2\" data-collection-item-field=\"subtitle\">Secure access for the Gannon Waye administration area</p></div><div data-source-location=\"src/components/AuthLayout.jsx:12:8\" data-dynamic-content=\"true\" class=\"bg-card rounded-2xl shadow-sm border border-border p-8\"><p data-source-location=\"src/pages/Login.jsx:41:6\" data-dynamic-content=\"false\" class=\"text-sm leading-6 text-muted-foreground mb-6\">Continue to Base44's secure sign-in service. After you sign in, you will return to the page you requested.</p><button data-source-location=\"src/pages/Login.jsx:45:6\" data-dynamic-content=\"true\" class=\"inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 bg-primary text-primary-foreground shadow hover:bg-primary/90 px-4 py-2 w-full h-12\" type=\"button\">Continue to secure sign-in</button><a data-source-location=\"src/pages/Login.jsx:50:8\" data-dynamic-content=\"false\" class=\"inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground h-9 px-4 py-2 w-full mt-3\" href=\"/\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" class=\"lucide lucide-arrow-left w-4 h-4 mr-2\" data-source-location=\"src/pages/Login.jsx:51:10\" data-dynamic-content=\"false\" aria-hidden=\"true\"><path d=\"m12 19-7-7 7-7\"></path><path d=\"M19 12H5\"></path></svg>Return to the public site</a></div><p data-source-location=\"src/components/AuthLayout.jsx:16:10\" data-dynamic-content=\"true\" class=\"text-center text-sm text-muted-foreground mt-6\" data-collection-item-field=\"footer\">No password or security code is collected by this website page.</p></div></div><div data-source-location=\"src/components/ui/toaster.jsx:28:4\" data-dynamic-content=\"true\" class=\"fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px] \" style=\"pointer-events: none;\"><div data-source-location=\"src/components/ui/toaster.jsx:43:6\" data-dynamic-content=\"false\" class=\"fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px] \" style=\"pointer-events: none;\"></div></div></div>
    <script type=\"text/javascript\" crossorigin=\"anonymous\" src=\"https://us-assets.i.posthog.com/array/phc_yAMDjc6mmR3xRyQhQQQngYB4ZXQ4mY9GoC9QKRwKp8ij/config.js\"></script><script type=\"module\" src=\"/src/main.jsx?t=1788434016617\"></script>
...
- generic [ref=e4]:
  - generic [ref=e5]:
    - img [ref=e7]
    - heading "Owner sign-in" [level=1] [ref=e10]
    - paragraph [ref=e11]: Secure access for the Gannon Waye administration area
  - generic [ref=e12]:
    - paragraph [ref=e13]: Continue to Base44's secure sign-in service. After you sign in, you will return to the page you requested.
    - button "Continue to secure sign-in" [ref=e14] [cursor=pointer]
    - link "Return to the public site" [ref=e15] [cursor=pointer]:
      - /url: /
      - img
      - text: Return to the public site
  - paragraph [ref=e16]: No password or security code is collected by this website page.
```
...
```ts
  ...
  91  |   });
  92  | 
  93  |   test('Signed-out visitors cannot inspect print-provider configuration', async ({ page }) => {
...
> 96  |     expect(html).not.toMatch(/[a-f0-9]{32,}/); // typical API key pattern (32+ hex chars)
      |                      ^ Error: expect(received).not.toMatch(expected)
  97  |     await expect(page.getByRole('heading', { name: 'Owner sign-in' })).toBeVisible();
  98  |     await expect(page.getByRole('button', { name: 'Continue to secure sign-in' })).toBeVisible();
  99  |   });
  100 | });
```