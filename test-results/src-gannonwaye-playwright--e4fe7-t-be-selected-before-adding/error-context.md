...
- Name: src\gannonwaye-playwright-pack\tests\store-load.spec.js >> Store Load & Product Cards >> apparel size must be selected before adding
- Location: src\gannonwaye-playwright-pack\tests\store-load.spec.js:70:3
