...
Received array:  ["Failed to load resource: the server responded with a status of 404 (Not Found)", "[Base44 SDK Error] 404: Request failed with status code 404", "Warning: Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.%s data-source-location·
    ...
    at div
    at MotionComponent (http://localhost:5173/node_modules/.vite/deps/framer-motion.js?v=19b29759:945:40)
    at div
    at MarqueeBar
    at div
    at Home (http://localhost:5173/src/pages/Home.jsx:47:30)
    at RenderedRoute (http://localhost:5173/node_modules/.vite/deps/react-router-dom.js?v=19b29759:4131:5)
    at Outlet (http://localhost:5173/node_modules/.vite/deps/react-router-dom.js?v=19b29759:4537:26)
    at PresenceChild (http://localhost:5173/node_modules/.vite/deps/framer-motion.js?v=19b29759:121:24)
    at AnimatePresence (http://localhost:5173/node_modules/.vite/deps/framer-motion.js?v=19b29759:210:26)
    at main
    at div
    at PublicLayout (http://localhost:5173/src/components/public/PublicLayout.jsx:26:24)
    at RenderedRoute (http://localhost:5173/node_modules/.vite/deps/react-router-dom.js?v=19b29759:4131:5)
    at Routes (http://localhost:5173/node_modules/.vite/deps/react-router-dom.js?v=19b29759:4601:5)
    at AuthenticatedApp (http://localhost:5173/src/App.jsx:334:82)
    at Router (http://localhost:5173/node_modules/.vite/deps/react-router-dom.js?v=19b29759:4544:15)
    at BrowserRouter (http://localhost:5173/node_modules/.vite/deps/react-router-dom.js?v=19b29759:5290:5)
    at QueryClientProvider (http://localhost:5173/node_modules/.vite/deps/@tanstack_react-query.js?v=41ea5f3a:3168:3)
    at AuthProvider (http://localhost:5173/src/lib/AuthContext.jsx:28:32)
