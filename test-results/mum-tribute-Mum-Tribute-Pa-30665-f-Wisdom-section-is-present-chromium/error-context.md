...
- Name: mum-tribute.spec.js >> Mum Tribute Page >> Sonia's Garden of Wisdom section is present
- Location: src/gannonwaye-playwright-pack/tests/mum-tribute.spec.js:108:3
...
Locator: locator('text=Sonia\'s Garden of Wisdom').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Sonia\'s Garden of Wisdom').first()
