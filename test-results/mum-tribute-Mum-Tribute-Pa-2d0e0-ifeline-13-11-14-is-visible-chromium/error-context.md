...
- Name: mum-tribute.spec.js >> Mum Tribute Page >> safety note (Lifeline 13 11 14) is visible
- Location: src/gannonwaye-playwright-pack/tests/mum-tribute.spec.js:131:3
...
Locator: locator('text=Lifeline').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Lifeline').first()
