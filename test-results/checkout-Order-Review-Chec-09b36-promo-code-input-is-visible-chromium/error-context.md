...
- Name: checkout.spec.js >> Order Review / Checkout Page >> promo code input is visible
- Location: src/gannonwaye-playwright-pack/tests/checkout.spec.js:137:3
...
Locator: locator('[data-testid="promo-code-input"]')
Expected: visible
Timeout: 10000ms
