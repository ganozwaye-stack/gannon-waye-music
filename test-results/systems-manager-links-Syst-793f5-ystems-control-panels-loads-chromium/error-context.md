...
- Name: systems-manager-links.spec.js >> Systems Manager — service destination pages load >> /systems/control-panels loads
...
Received string: "
    Support Now404Page Not FoundThe page \"systems/control-panels\" could not be found.Go Home
...
- paragraph: The page "systems/control-panels" could not be found.
- button "Go Home"
```
