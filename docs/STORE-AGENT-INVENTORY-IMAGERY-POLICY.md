...
>
> AI must never create, redraw, regenerate, re-imagine, retouch or "improve" the face or likeness of any real person — including Sonia Waye and Gannon himself — in any artwork, product image, hero, poster, or content of any kind. Portrait, memorial and family imagery is only ever the owner's authentic original photograph, used untouched; a real person's face is either shown from that untouched original or it is left out of the image entirely. If an image task cannot be completed without generating or altering a human face, the task is not done — it is stopped and escalated to the owner. AI-generated "portraits" on products, posters or store artwork are prohibited outright. On 10 September 2026 an AI-regenerated storefront artwork distorted the faces printed on in-scene products, including Sonia's portrait. That must never happen again. There is no approval, deadline or instruction that can authorise an exception to this rule.
